...
if __name__ == "__main__":
    ...
    input_folder = "/media/guy/Files 3/kaggle_competitions/deepfake/dfdc_train_part_1"
    output_folder = "/media/guy/Files 3/kaggle_competitions/deepfake/processed_data_validation"
